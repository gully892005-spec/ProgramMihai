...
const API_CONFIG = {
   ...
   * Obții cheia de pe: https://rapidapi.com/DataCrawler/api/booking-com15
   * Endpoint: https://booking-com15.p.rapidapi.com/api/v1/hotels/searchHotels
   */
  BOOKING: {
    ENABLED: false,                   // ← schimbă în `true` când adaugi cheia
    KEY: "PUNE_CHEIA_BOOKING_AICI",   // ← înlocuiește cu RapidAPI Key
   ...
   * Obții cheia de pe: https://rapidapi.com/3b-data-3b-data-default/api/skyscanner44
   * Endpoint: https://skyscanner44.p.rapidapi.com/search-flights
   */
  SKYSCANNER: {
    ENABLED: false,                      // ← schimbă în `true` când adaugi cheia
    KEY: "PUNE_CHEIA_SKYSCANNER_AICI",   // ← înlocuiește cu RapidAPI Key
   ...
   * Opțional pentru date zbor detaliate.
   * Obții cheia de pe: https://rapidapi.com/aerodatabox/api/aerodatabox
   */
  FLIGHTS: {
    ENABLED: false,
    KEY: "PUNE_CHEIA_FLIGHTS_AICI",
...
/**
 * Aplică filtrele active (tip, transport, persoane, buget).
 * @param {Array} offers
 * @returns {Array}
 */
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  console.info(
    "%c SmartTravel AI v1.0 %c Gata! Configurează cheile API în app.js pentru date live. ",
